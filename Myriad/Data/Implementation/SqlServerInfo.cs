...
namespace Myriad.Data.Implementation
{
    public class SqlServerInfo
    {
        ...
        internal static Dictionary<(DataOperation, int), string> parameterNames = new Dictionary<(DataOperation, int), string>()
        {
            ...
            { (DataOperation.WriteImageSize, Ordinals.first), keyName },
            { (DataOperation.WriteImageSize, Ordinals.second), keyWidth },
            { (DataOperation.WriteImageSize, Ordinals.third), keyHeight }
        };
        ...
        {
            { (DataOperation.WriteImageSize, Ordinals.first), System.Data.SqlDbType.NVarChar },
            { (DataOperation.WriteImageSize, Ordinals.second), System.Data.SqlDbType.Float },
            { (DataOperation.WriteImageSize, Ordinals.third), System.Data.SqlDbType.Float }
        };
        ...
        internal static Dictionary<DataOperation, string> Selectors = new Dictionary<DataOperation, string>()
        {
            ...
            {DataOperation.WriteImageSize,
                "insert into ImageSizes (name, width, height) values ("+
                parameterNames[(DataOperation.WriteImageSize, Ordinals.first)]+","+
                parameterNames[(DataOperation.WriteImageSize, Ordinals.second)]+","+
                parameterNames[(DataOperation.WriteImageSize, Ordinals.third)]+")" }
        };
